...
print(
    "La multiplicacion del primer valor por el segundo + el tercero es igual a :",
    (num1 * num2) + num3,
)
...
num1 = float(
    input(
        "Ingrese el radio de una circunferencia para que pueda calcular el perímetro :"
    )
)
...
num1 = float(
    input("Ingrese el radio de una circunferencia para que pueda calcular el área :")
)
